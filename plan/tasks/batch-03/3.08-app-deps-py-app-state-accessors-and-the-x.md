...
track_scope: "server"
title: "`app/deps.py` — app-state accessors and the `X-Boomerang-Client-Version` gate"
kind: "implementation"
package: "server/app"
...
status: "not_started"
---
#### Task 3.8: `app/deps.py` — app-state accessors and the `X-Boomerang-Client-Version` gate
